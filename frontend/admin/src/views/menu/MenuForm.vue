...
import ReAnimateSelector from "@bit-labs.cn/owl-ui/components/ReAnimateSelector";
import {
  menuTypeOptions,
  showLinkOptions,
  fixedTagOptions,
...
const props = withDefaults(
  defineProps<{ formInline: MenuFormData }>(),
  {
    formInline: () => ({
      menuType: 0,
      higherMenuOptions: [],
